...
var panesApp = new Vue({
  ...
  mounted: function(){
    ...
    $.ajax({
      type: 'GET',
      url: 'https://iamngoni-env.eba-webtmyzh.us-east-2.elasticbeanstalk.com/memory/get'
    }).done((response) => {
  ...
  watch: {
    tiles: function(value){
      if(value.length < 1){
        ...
        $.ajax({
          type: 'POST',
          url: "https://iamngoni-env.eba-webtmyzh.us-east-2.elasticbeanstalk.com/memory/save",
